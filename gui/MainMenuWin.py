...
class MainMenuWin(QtGui.QMainWindow):
    ...
    def init_ui(self):
        ...
        Icon3=QtGui.QPixmap("gui/img/userbutton.png")
        ...
        Icon4=QtGui.QPixmap("gui/img/newuserbutton.png")
        ...
        Icon4=QtGui.QPixmap("gui/img/startbutton.png")
        Icon_resize5= Icon4.scaled(self.winsize_h*0.21 ,self.winsize_h*0.21,QtCore.Qt.KeepAspectRatio, transformMode=QtCore.Qt.SmoothTransformation)
        self.stop.setPixmap(Icon_resize5)
        ...
        Icon4=QtGui.QPixmap("gui/img/stadistbutt.png")
        Icon_resize5= Icon4.scaled(self.winsize_h*0.21 ,self.winsize_h*0.21,QtCore.Qt.KeepAspectRatio, transformMode=QtCore.Qt.SmoothTransformation)
        self.stop.setPixmap(Icon_resize5)
        ...
        Icon4=QtGui.QPixmap("gui/img/settingsbutton.png")
        Icon_resize5= Icon4.scaled(self.winsize_h*0.21 ,self.winsize_h*0.21,QtCore.Qt.KeepAspectRatio, transformMode=QtCore.Qt.SmoothTransformation)
        self.stop.setPixmap(Icon_resize5)
        ...
        Icon4=QtGui.QPixmap("gui/img/button.png")
        Icon_resize5= Icon4.scaled(self.winsize_h*0.21 ,self.winsize_h*0.21,QtCore.Qt.KeepAspectRatio, transformMode=QtCore.Qt.SmoothTransformation)
        self.stop.setPixmap(Icon_resize5)
